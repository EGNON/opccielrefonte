    ...
    public void generate()
    {
        String[] roles = {
           ...
           "ROLE_TYPEEVENEMENT","ROLE_TYPEGARANT","ROLE_TYPEOBLIGATION","ROLE_SECTEURBOURSIER", "ROLE_PHYSIQUE", "ROLE_MORALE",
                ...
                "ROLE_TARIFICATION_OPC","ROLE_PROFIL_OPC","ROLE_COMPTE_BANQUE_OPCVM","ROLE_ETAT_RATIO_SHARP","ROLE_ETAT_RATIOTREYNOR","ROLE_CHARGE_A_ETALER","ROLE_TYPEMODELE",
                "ROLE_NAVBENCHMARK","ROLE_INTENTION_RACHAT","ROLE_RACH_VERIF_N1","ROLE_RACH_VERIF_N2","ROLE_GENERATION_RACHAT",
                "ROLE_PAIEMENT_RACHAT","ROLE_AVIS_RACHAT","ROLE_ORDRE_BOURSE","ROLE_VALIDATION_ORDRE","ROLE_IMPRESSION_ORDRE",
                "ROLE_AVIS_ORDRE","ROLE_CONSTITUTION_CAPITAL","ROLE_VERIF_NIV1_CC","ROLE_VERIF_NIV2_CC","ROLE_VALO_POSTE_COMPTABLE",
                "ROLE_VERIF_NIV1_PC","ROLE_VERIF_NIV2_PC","ROLE_CLOTURE_SEANCE0","ROLE_IMPORT_DEPOT_SOUS","ROLE_DEPOT_SOUS",
                "ROLE_VERIF_NIV1_DEPOT_SOUS","ROLE_VERIF_NIV2_DEPOT_SOUS","ROLE_GENERATION_SOUS","ROLE_RESTITUTION_RELIQUAT",
                "ROLE_AVIS_SOUS","ROLE_VERIF_ECRITURE_N1","ROLE_VERIF_ECRITURE_N2","ROLE_CONSULT_ECR","ROLE_CONS_CHARGE",
                "ROLE_PAIE_CHARGE","ROLE_REGUL_ECART_SOLDE","ROLE_PAIEMENT_COMMISSION","ROLE_TRANS_PARTS","ROLE_RETRO_COM_INVEST",
                "ROLE_ECRITURE_MANUEL","ROLE_AUGMENTATION_CAPITAL","ROLE_EXTOURNE_VDE","ROLE_VERIF1_VDE","ROLE_VERIF2_VDE",
                "ROLE_VERIF1_EXTOURNE_VDE","ROLE_VERIF2_EXTOURNE_VDE","ROLE_SOLDE_COMPTE_EXTOURNE","ROLE_REGLEMENT_LIVRAISON",
                "ROLE_GENERATION_REGLEMENT_LIVRAISON","ROLE_EVT_DETACHEMENT","ROLE_EVT_AVIS","ROLE_GENERATION_DIFF_ESTIMATION",
                "ROLE_VERIFICATION_NIVEAU1_DE","ROLE_VERIFICATION_NIVEAU2_DE","ROLE_VERIF_ECRITURE_NIVEAU1_DE",
                "ROLE_VERIF_ECRITURE_NIVEAU2_DE","ROLE_AMORTISSEMENT_CHARGE","ROLE_VERIF_CHARGE1","ROLE_VERIF_CHARGE2",
                "ROLE_VERIF_ECRITURE_CHARGE1","ROLE_VERIF_ECRITURE_CHARGE2","ROLE_VALORISATION_CODE_POSTE","ROLE_VERIF_PC_N1",
                "ROLE_VERIF_PC_N2","ROLE_CLOTURE_SEANCE"
        };
