...
public class OperationDifferenceEstimation {
	...
	public CleOperationDifferenceEstimation getIdOperationDifferenceEstimation() {
		return idOperationDifferenceEstimation;
	}

	public void setIdOperationDifferenceEstimation(CleOperationDifferenceEstimation idOperationDifferenceEstimation) {
		this.idOperationDifferenceEstimation = idOperationDifferenceEstimation;
	}
