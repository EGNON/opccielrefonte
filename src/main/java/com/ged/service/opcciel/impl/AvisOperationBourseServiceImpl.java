...
public class AvisOperationBourseServiceImpl implements AvisOperationBourseService {
    ...
    public AvisOperationBourseServiceImpl(com.ged.dao.opcciel.AvisOperationBourseDao avisOperationBourseDao, OpcvmDao opcvmDao, com.ged.mapper.opcciel.AvisOperationBourseMapper avisOperationBourseMapper){
...
//            Sort sort = Sort.by(Sort.Direction.ASC,"libellePlan");
    ...
    public ResponseEntity<Object> creer(AvisOperationBourseDto avisOperationBourseDto) {
        try {
            ...
            q.registerStoredProcedureParameter("valeurFormule", BigDecimal.class, ParameterMode.IN);
            q.registerStoredProcedureParameter("valeurCodeAnalytique", BigDecimal.class, ParameterMode.IN);
...
//            codeRole=AvisOperationBourseDto.getRole();
//
//            Double coursLimite=Double.valueOf(0);
//            Double quantiteLimite=Double.valueOf(0);
//            if(AvisOperationBourseDto.getCoursLimite()!=null){
//                coursLimite=Double.valueOf(AvisOperationBourseDto.getCoursLimite().toString());
//            }
//            if(AvisOperationBourseDto.getQuantiteLimite()!=null){
//                quantiteLimite=Double.valueOf(AvisOperationBourseDto.getQuantiteLimite().toString());
//            }
//            montantBrut = new BigDecimal(BigDecimal.valueOf(coursLimite
//                    * quantiteLimite).toString()).setScale(0);
//
//            if(AvisOperationBourseDto.getTitre()!=null && AvisOperationBourseDto.getTitre().getIdTitre()!=null){
//                Titre titre=titreDao.findById(AvisOperationBourseDto.getTitre().getIdTitre()).orElseThrow();
...
//                {
//                    interetCourru = new BigDecimal(Double.valueOf(libraryDao.interetCouru(titre.getIdTitre(),AvisOperationBourseDto.getDateAvisOperationBourse(), false,null).toString()) *
...
//                }
//                //SGI
//                Registraire registraire=registraireDao.findByIdPersonne(AvisOperationBourseDto.getPersonne().getIdPersonne());
//                TarificationProjection objTOS = tarificationOrdinaireDao.afficherTarificationS(codeClasseTitre,
//                        registraire.getIdRegistraire(),codeRole,AvisOperationBourseDto.getOpcvm().getIdOpcvm());
//                if (objTOS != null)
//                {
...
//                quantiteDisponible = libraryDao.quantiteReelTitre(AvisOperationBourseDto.getOpcvm().getIdOpcvm(), titre.getIdTitre(), AvisOperationBourseDto.getDateAvisOperationBourse());
//            }
//
...
//            AvisOperationBourseDto.setiRVM(irvm);
//            AvisOperationBourseDto.setInteret(interetCourru.doubleValue());
//            AvisOperationBourseDto.settAF(tafCommissionSGI);
//            AvisOperationBourseDto.setQuantiteDisponible(quantiteDisponible);
//
//            return ResponseHandler.generateResponse(
//                    "Enregistrement effectué avec succès !",
//                    HttpStatus.OK,
