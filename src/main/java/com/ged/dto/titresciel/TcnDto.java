...
public class TcnDto extends TitreDto {
    ...
    private NatureTcnDto natureTcn;
    private ModeCalculInteretDto formulePrecomptee;
    ...
    public NatureTcnDto getNatureTcn() {
        return natureTcn;
    }

    public void setNatureTcn(NatureTcnDto natureTcn) {
        this.natureTcn = natureTcn;
    }

    public ModeCalculInteretDto getFormulePrecomptee() {
        return formulePrecomptee;
    }

    public void setFormulePrecomptee(ModeCalculInteretDto formulePrecomptee) {
