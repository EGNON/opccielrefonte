...
public class OperationEvenementSurValeurDto extends OperationDto {
    ...
    private OperationDetachementDto operationDetachement;
	private String referenceAvis;
	private String userLogin;

//    private Boolean supprimer;
    public OperationEvenementSurValeurDto() {
    }
    ...
    public OperationDetachementDto getOperationDetachement() {
        return operationDetachement;
    }

    public void setOperationDetachement(OperationDetachementDto operationDetachement) {
