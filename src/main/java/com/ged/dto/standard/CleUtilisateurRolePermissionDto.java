...
@Embeddable
public class CleUtilisateurRolePermissionDto implements Serializable {
    private Long idUtilisateur;
    private Long idRole;
    private Long idPermis;

    public CleUtilisateurRolePermissionDto() {
    }

    public CleUtilisateurRolePermissionDto(Long idUtilisateur, Long idRole, Long idPermis) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CleUtilisateurRolePermissionDto that)) return false;
